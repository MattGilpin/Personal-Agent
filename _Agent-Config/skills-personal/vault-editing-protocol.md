---
name: vault-editing-protocol
description: "REQUIRED: Load this skill before touching Matt's vault at ~/.hermes/vault. Every vault edit must be timestamped, chronological, and supersession-aware."
---
...
- Matt shares new information that should be persisted
...
title: Note Title
type: reference
created: 2026-06-24T00:00:00+04:00
updated: 2026-06-24T00:00:00+04:00
---
```
...
| Date | Status | Notes |
|------|--------|-------|
| 2026-07-01 | Active | Project restarted |
| 2026-06-15 | Paused | Superseded 2026-07-01 |
```

## Quality Checklist

Before confirming a vault update:
- [ ] Target file was read first
- [ ] Change has a timestamp (frontmatter updated:)
- [ ] Dated entries are oldest to newest
- [ ] Old entries marked Superseded, not deleted
- [ ] No em dashes or en dashes in new lines
- [ ] Validator passed
- [ ] Git commit done if change is durable
